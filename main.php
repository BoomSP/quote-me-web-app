...
<html>
  ...
  <form action"#" method="post">
    ...
    <input type="text" class="form-control" name="id" placeholder="Enter ID to Edit or Delete/ Enter any words in Quotes, Sources, or Authors to Search/ Click 'Search' once again to reset search keywords">
...
<form action="#" method="post">
  ...
  $query = "select * from 50quotes where Username = '$_SESSION[uuu]' and (quote like '%$idd%' or source like '%$idd%' or author like '%$idd%')";
  $stmt = $dbh->query($query);
